...
class SettingController extends AdminBaseController
{
    ...
    public function appPost()
    {
        if ($this->request->isPost()) {
            //TODO 非空验证
            $appSetting = $this->request->post();

            cmf_set_option('app_settings', $appSetting);
            $this->success('保存成功！');
        }
    }
     ...
     * )
     */
    public function broadcastPost()
    {
        if ($this->request->isPost()) {
            //TODO 非空验证
            $broadcastSetting = $this->request->post();

            cmf_set_option('broadcast_settings', $broadcastSetting);
            $this->success('保存成功！');
        }
    }
    ...
    public function vipPost()
    {
        if ($this->request->isPost()) {
            ...
            cmf_set_option('vip_settings', ['list'=>$vipSetting]);
            $this->success('保存成功！');
        }
    }
}