<?php
namespace plugins\mobile_code;//Demo插件英文名，改成你的插件英文就行了
use cmf\lib\Plugin;

ini_set("display_errors", "on");

require_once dirname(__DIR__) . '/mobile_code/api_sdk/vendor/autoload.php';
 ...
 * 备注:Demo工程编码采用UTF-8
 */
class MobileCodePlugin extends Plugin
{
    public $info = [
        'name'        => 'MobileCode',
        'title'       => '阿里云手机验证码',
    ...
    public function sendMobileVerificationCode($param){
        ...
        $request->setTemplateCode($config['mode_id']);
...
//        $request->setSmsUpExtendCode("1234567");
        ...
        }else
        {
            $result = [
                'error'     => 1,
                'message' => '验证码发送失败'.$acsResponse->Code
            ];
        }
        return $result;
    }
